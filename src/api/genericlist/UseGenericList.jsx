...
export const useGenericList = (dispatch) => {
    const genericlistApi = axios.create({
        baseURL: 'http://soapp_laravel.thinkwg.com/'
        //baseURL: 'http://127.0.0.1:8080/'

    });

    genericlistApi.interceptors.request.use(
        (config) => {
    ...
    genericlistApi.interceptors.response.use((response) => {
